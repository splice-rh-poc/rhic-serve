      ...
      [
        {
          ...
          "resource_uri": "https://example.com/api/rhicrcs/7dd72d62-fcf2-4e5c-a659-273bb88bd509/",
        ...
        },
        {
          ...
          "resource_uri": "https://example.com/api/rhicrcs/5e6a8a78-ceb9-4835-80c8-4b2b337ebec4/",
        ...
        },
        {
          ...
          "resource_uri": "https://example.com/api/rhicrcs/cc11f76f-8f82-433f-bc37-c61b5bf43d19/",
...
.. http:get:: /api/v1/rhicrcs/(str:uuid)/
   ...
   Get a single rhic that is available to the rcs.

   **Sample Request**:

   .. sourcecode:: http
      
      GET /api/v1/rhicrcs/cc11f76f-8f82-433f-bc37-c61b5bf43d19 HTTP/1.1
      Host: example.com
      Accept: application/json
